...
hi StatusLine	cterm=none ctermbg=000							gui=bold guibg=grey20
...
hi LineNr		ctermfg=32 ctermbg=000							guifg=steelblue guibg=grey20
hi MoreMsg		ctermfg=82										gui=bold guifg=#60ff60
hi NonText		ctermfg=black ctermbg=000   					gui=bold guifg=lightblue guibg=grey10
...
hi CursorLine	cterm=none ctermbg=000							guibg=grey30
hi CursorLineNr	ctermbg=000										guibg=grey30
